...
import { checkFollow, EditProfile, followUnfollow, getAllUsers, getLogindUser, getUserProfile } from '../controllers/user/userController.js'
...
Router.patch('/api/edit',verifytoken, tryCatch(EditProfile))
